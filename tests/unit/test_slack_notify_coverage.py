...
def test_slack_webhook_enabled_true(monkeypatch):
    ...
    from statuspage_prometheus_exporter.slack_notify import slack_webhook_enabled
...
def test_get_webhook_url_returns_env(monkeypatch):
    ...
    from statuspage_prometheus_exporter.slack_notify import _get_webhook_url
...
def test_format_affected_non_list_parts():
    from statuspage_prometheus_exporter.slack_notify import _format_affected
