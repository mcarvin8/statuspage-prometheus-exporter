...
def test_save_and_load_roundtrip(cache_dir):
    from statuspage_prometheus_exporter.cache_manager import save_service_response, load_service_response
...
def test_load_missing_returns_none(cache_dir):
    from statuspage_prometheus_exporter.cache_manager import load_service_response
...
def test_clear_specific_service(cache_dir):
    from statuspage_prometheus_exporter.cache_manager import save_service_response, clear_cache, load_service_response
...
def test_atomic_write_no_tmp_file_left(cache_dir):
    from statuspage_prometheus_exporter.cache_manager import save_service_response
...
def test_clear_nonexistent_service_is_noop(cache_dir):
    from statuspage_prometheus_exporter.cache_manager import clear_cache
